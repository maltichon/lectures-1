...
# fitting wordscores
ws <- textmodel_wordscores(ukDfm, c(17.21, 5.35, 8.21, rep(NA, 3))) #first 3 are reference, last 3 are the virgins
...
refpoints[test] <- NA
# running wordscores
ws <- textmodel_wordscores(cdfm, refpoints, smooth=.5) #tests' refpoints are NA and those are virgin texts
# predicted values
